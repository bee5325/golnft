...
<template>
  <form @submit.prevent="submit">
    ...
    <textarea class="w-2xl h-200px border-gray-300 border-1 border-solid px-2 py-1" v-model="feedback"></textarea>
    <label class="block font-bold">Your email</label>
    <input class="w-2xl border-gray-300 border-1 border-solid px-2 py-1 block" type="email" v-model="email" />
